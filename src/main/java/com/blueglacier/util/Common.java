package com.blueglacier.util;

import com.blueglacier.disposition.ContentDispositionDecoder;
...
public class Common {
    ...
    public static String getAttachmentNameFromDispositionParameters(BodyDescriptor bd) {
        ...
        if (bd instanceof MaximalBodyDescriptor) {
            ...
            if (StringUtils.isEmpty(attachmentName)) {
                //Handling case where RFC 2183 is not properly implemented by com.blueglacier.email creating client.
	...
	public static String getAttachmentName(BodyDescriptor bd){		
		// Content com.blueglacier.disposition 'filename' is more standard, so it's taken as default first
